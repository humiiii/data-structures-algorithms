# Logic Building: Flowcharts and Pseudocode

## 0. What is an Algorithm?

An **Algorithm** is a finite set of well-defined instructions to solve a specific problem. It is the core logic behind any program.
...
Before writing a single line of C++, we have to learn how to **think** like a programmer. 
